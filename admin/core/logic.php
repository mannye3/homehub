...
//===============================LOGIN SECTION========================//
      if (isset($_POST['login'])) {
            ...
            if($row['email']!=$email && $row['password']!=$password){
              ...
              $ermsg2 = '<div class="alert alert-danger alert-dismissible">
                        <a href="#" class="close" data-dismiss="alert" data-context="error" aria-label="close">&times;</a>
                        <strong>Invalid login details,Please check your email and password</strong>
                        </div>';
...
if(isset($_POST["message"])) {
    ...
    $sql = "INSERT INTO `message`(`subject`,`name`, `msg`, `user_code`, `email`, `msg_date`,`status`, `num`, `msg_code`) VALUES ('".$subject."','".$name."','".$msg."','".$user_code."','".$email."','".$msg_date."','1','1','".$msg_code."')";
