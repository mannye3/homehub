<?php
$sql12 ="SELECT SUM(num) AS approve FROM property WHERE email='$user_check' AND status=1 ";
	...
	$sql13 ="SELECT SUM(num) AS review FROM property WHERE email='$user_check' AND status=0 ";
