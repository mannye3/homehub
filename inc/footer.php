    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8">
                <p class="copy">©  <?php echo date('Y'); ?>  Designed by <a href="http://e3tech.com.ng/" target="_blank">E3 Technologies</a> 
                </p>
            </div>
...
<!-- Mirrored from storage.googleapis.com/themevessel-items/neer/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Dec 2018 11:43:44 GMT -->
</html>